...
describe "Allowables::ActiveRecord::Subject" do
  it "should extend the model with RoleMethods" do
    ...
    User.ancestors.include?(Allowables::ActiveRecord::Subject::RoleMethods).should == true
  end

  it "should extend the model with PermissionMethods if permissions are enabled" do
    User.acts_as_authorization_subject
    User.ancestors.include?(Allowables::ActiveRecord::Subject::PermissionMethods).should == true
  end
  ...
  describe "PermissionMethods" do
    ...
    describe "assign_permission" do
      ...
      it "should accept an optional context" do
        permission = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100)
      ...
      it "should use target_permission to lookup the closest contextual match when a permission slug is provided" do
        context = Context.create(:name => "Test Context")
        nil_permission = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100)
        class_permission = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100, :context_type => 'Context')
        inst_permission = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100, :context_type => 'Context', :context_id => context.id)
    ...
    describe "permissions_for" do
      ...
      it "should use nil context when none is provided" do
        edit_permission = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100)
      ...
      it "should return all permissions assigned to the subject within the provided context" do
        nil_edit = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100)
        class_edit = Permission.create(:name => 'Edit', :slug => 'edit', :level => 100, :context_type => 'Context')
        class_view = Permission.create(:name => 'View', :slug => 'view', :level => 80, :context_type => 'Context')
