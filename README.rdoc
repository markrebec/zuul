...
* +require_no_user_message+
  ...
  The string that will be added to the flash[:notice] if the requested action requires there be NO user signed in and there is on. Defaults to "You must be logged out to access this page".
